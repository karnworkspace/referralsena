...
class AgVisit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('agent_id, cus_id, project', 'length', 'max'=>20),
			array('visit_date', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, agent_id, cus_id, project, visit_date, create_date','status','staff_id','status_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'status_date'=>'วันที่ Update สถานะ',
		);
	}
