...
<head>
    ...
    <title>Marketing Comunication Work Progress System</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
            ...
            foreach ($role as $role){
				...
				switch ($role_name) {
					case "admin":
						$this->renderPartial('//layouts/left-slidebar-super-user');
					break;
					case "MarcomAdmin":
						$this->renderPartial('//layouts/left-slidebar-marcom-admin');
					break;
					case "MarcomManager":
						$this->renderPartial('//layouts/left-slidebar-marcom-manager');
					break;
					case "MarcomUser":
						$this->renderPartial('//layouts/left-slidebar-marcom-user');
					break;
					default:
						//$this->renderPartial('//layouts/left-slidebar');
