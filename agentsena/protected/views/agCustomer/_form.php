...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr class="odd"><th><?php echo $form->labelEx($model,'ชื่อลูกค้า*'); ?></th>
		<td><?php echo $form->textField($model,'fname',array('size'=>50,'minlength'=>2,'maxlength'=>50,'class' => 'col-9')); ?><?php echo $form->error($model,'fname'); ?></td></tr>

	<tr class="even"><th><?php echo $form->labelEx($model,'สกุลลูกค้า*'); ?></th><td><?php echo $form->textField($model,'lname',array('size'=>50,'minlength'=>2,'maxlength'=>50,'class' => 'col-9')); ?>
	<?php echo $form->error($model,'lname'); ?></td></tr>

	<tr class="col-4"><th><?php echo $form->labelEx($model,'โครงการที่ลูกค้าสนใจ*'); ?></th><td><?php echo $form->dropDownList($model,'project', CHtml::listData(Project::model()->findAll(array('order' => 'project_name ASC','condition' => 'active ="y"')), 'id', 'project_name', 'project_type'), array('empty'=>'กรุณาเลือกโครงการ')) ?>
...
<tr class="odd"><th><?php echo $form->labelEx($model,'เบอร์โทรลูกค้า*'); ?></th><td><?php echo $form->textField($model,'phone',array('size'=>15,'maxlength'=>15,'class' => 'col-9')); ?>
<?php echo $form->error($model,'phone'); ?></td></tr>

<tr class="even"><th><?php echo $form->labelEx($model,'รหัสบัตรประชาชนลูกค้า'); ?></th><td><?php echo $form->textField($model,'idcard',array('size'=>15,'maxlength'=>15,'class' => 'col-9')); ?>
