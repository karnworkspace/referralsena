...
<div class="alert alert-success" role="alert">
  เพิ่มข้อมูลรายชื่อลูกค้าของท่านเพื่อให้เสนาฯ ตรวจสอบข้อมูล โดยระยะเวลาลูกค้าจะต้องไม่เคยเป็นผู้เข้าเยี่ยมชมโครงการ หรือลงทะเบียนบนเว็บไซต์ตั้งแต่ 1 ธันวาคม 2562- ปัจจุบัน
</div>
...
เนื่องจากรายชื่อลูกค้าท่านนี้เคยสนใจโครงการของเสนาตั้งแต่ 1 ธันวาคม 2562 - ปัจจุบัน</small></span>"; }else {
