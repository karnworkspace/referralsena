...
?>
	<tr class="<?php echo CHtml::encode($value_model->id); ?>">
				...
				<td><strong><?php if(CHtml::encode($value_model->status)=='0'){?><button type="button" class="btn btn-mini btn-block btn-success" data-toggle="popover" data-placement="top" title="นัดหมายเรียบร้อยแล้ว คืออะไร?" data-content="ให้ท่านนำลูกค้าไปยัง Sale Gallery โครงการที่ต้องการ (ด้วยตัวท่านเอง) เพื่อให้เซลล์ของเราได้แนะนำรายละเอียดแก่ลูกค้าของท่าน หลังจากนั้นท่านสามารถติดตามผลการโอนห้อง อนุมัติสินเชื่อธนาคาร และอื่นๆ ของลูกค้า ได้จากเซลล์ที่ปรึกษาของท่าน">นัดหมายเรียบร้อยแล้ว</button><?php }else if(CHtml::encode($value_model->status)=='1'){  ?><button type="button" class="btn btn-mini btn-block btn-success">ยืนยันการจองแล้ว</button><?php } ?></strong></td>
	    </tr>
<?php
}
?>
