<?php
class uniqueMultiColumnValidator2 extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if($exists)
		{
			...
			$message = $this->message!==null ? $this->message : "ไม่สามารถนัดหมายเยี่ยมชมโครงการในวันเดียวกันได้ กรุณาเลือกวันนัดหมายใหม่";
			foreach ($attributes as $attribute)
			{
